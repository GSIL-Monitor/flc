        ...
        <div class="add_content" id="form-article-add">
            <ul>
                <li class="clearfix Mandatory">
                    ...
                    <span class="formControls col-10"><input name="文章标题" type="text" id="articleTitle" class="col-xs-10 col-sm-5 " value="${article.articleTitle}"></span>
                </li>
                <li class="clearfix">
                    ...
                    <span class="formControls col-10">
                        <span class="add_date l_f">
                            ...
                            <c:if test="${article.articleType == 2}">
                                <label><input name="radio" type="radio" class="ace" value="1"><span class="lbl">显示</span></label>&nbsp;
                                <label><input name="radio" type="radio" class="ace" value="2" checked><span class="lbl">不显示</span></label>
                            </c:if>
                        </span>
                    </span>
                </li>
                <li class="clearfix">
                    ...
                    <textarea name="content1" id="product" style="width:90%;height:500px;margin:0 auto;" placeholder="请输入内容...">${article.articleContent}</textarea>
                </li>
            </ul>
            ...
            for (var i = 0; i < articleType.length; i++){
                if (articleType[i].checked == true){
                    ...
                    if (!!editorValue){
                        $.ajax({
                            type : 'post',
                            url : '${pageContext.request.contextPath}/admin/update_article',
                            data : {
                            ...
                            success : function (result) {
                                if (result){
                                    layer.msg('修改成功！', {icon: 1, offset: 't'},function () {
