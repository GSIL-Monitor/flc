...
<div class="margin clearfix">
    <div class="Shops_Audit">
        <div class="prompt">当前共有<b>${storeStatusRejectList}</b>家店铺被驳回申请</div>
        <!--申请列表-->
            ...
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <c:forEach items="${storeAuditList}" var="store"  >
                    <tr>
                        ...
                        <td class="td-manage">
                            <a title="店铺详细" href="${pageContext.request.contextPath}/store/getstorebyid?audit=reject&id=${store.id}" class="btn btn-xs btn-info Refund_detailed">详细</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
