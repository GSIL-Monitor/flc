...
<form  action="${pageContext.request.contextPath }/brand/addbrand" method="post" enctype="multipart/form-data">
    <div id="add_brand" class="clearfix">
        <div class="left_add" style="margin-left: 30%;border-left: 1px solid #ddd;">
            <div class="title_name">添加品牌信息</div>
            <ul class="add_conent">
                <li class=" clearfix">
                    ...
                    <div class="demo l_f">
                        <div class="logobox">
                            <div class="resizebox" style="width: 240px;height: 160px;">
                                <img id="pic" src="" style="width: 150px;height: 150px;margin:0px auto;cursor: pointer;"
                                     alt=""/>
                                <input id="upload" name="adverPic" accept="image/*" type="file" style="display: none"
                ...
                <li class=" clearfix">
                    ...
                    <textarea name="brandDescription" cols="" rows="" class="textarea"
                ...
                <li class=" clearfix">
                    ...
                    <label>
                        <input name="brandType" type="radio" class="ace" checked="checked" value="1">
                        <span class="lbl">显示</span>
                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label>
                        <input name="brandType"  type="radio" class="ace" value="2">
    ...
    <div class="button_brand">
        ...
        <input name="" type="reset" value="返回" class="btn btn-warning"/>
    </div>
</form>
</body>
</html>
    ...
    function validate_img(ele) {
        ...
        if (!/.(jpg|jpeg|png|JPG|bmp)$/.test(file)) {
            $('body').dialog({
                ...
                discription: '图片类型必须是jpeg,jpg,png,bmp中的一种!',
