...
public class MySQLDatabaseBackup {
	...
	//	try {
	//		if (exportDatabaseTool("47.92.203.99", "root", "huangwei","c:/Database", f.format(date) + ".sql", "flchappinessmall")) {
	...
	/*public static void main(String[] args) {
		try {
			if (exportDatabaseTool("47.92.203.99", "root", "huangwei","D:/ZDSAPPDatabase", "2014-10-14.sql", "flchappinessmall")) {
				System.out.println("数据库成功备份！！！");
			} else {
				System.out.println("数据库备份失败！！！");
			}
